...
const LocationMap = () => {
    return (
        <div className="flex flex-col md:flex-row justify-evenly items-center">
            {/* Map section */}
            <div className="md:w-2/5 pr-4 md:p-0">
                <ResponsiveIframe />
                {/* Text section */}
                ...
                <Card className="max-w-lg w-full rounded overflow-hidden shadow-lg flex flex-col items-center ">
                    <div className='grid grid-cols-1 md:grid-cols-2 w-full mx-4 md:gap-8'>
                        <div className='mt-2 mb-2' >
                            ...
                            <p>
                                <a className="text-blueMedium hover:text-blue-gray-600" href="tel:+18134686878">+1 (720) 468-2411</a>
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="list-none leading-normal space-y-0.5">
                                <li><span className="font-bold">Mon</span>: 8:00 - 16:00</li>
                                <li><span className="font-bold">Tue</span>: 8:00 - 16:00</li>
                                <li><span className="font-bold">Wed</span>: 8:00 - 16:00</li>
                                <li><span className="font-bold">Thu</span>: 8:00 - 16:00</li>
                                <li><span className="font-bold">Fri</span>: 8:00 - 16:00</li>
                                <li><span className="font-bold">Sat</span>: Closed</li>
